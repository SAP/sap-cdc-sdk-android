 ...
 * 
 * TD3 Format Specification (ICAO 9303 Part 4):
 ...
 *         └──────┘│└─┘└────┘│└────┘│└─────────────┘│
 *           Doc# │Nat  DOB  │Expiry│  Personal#    Composite
 *              Chk│    Chk   │    Chk             Chk
 * 
 * Checksums validated:
 ...
 * 4. Personal number (line 2, position 43) - optional
 * 5. Composite (line 2, position 44)
 * 
 * @see <a href="https://www.icao.int/publications/Documents/9303_p4_cons_en.pdf">ICAO 9303 Part 4</a>
 */
class TD3Parser : MRZParser {
    
    override val supportedFormat: MRZFormat = MRZFormat.TD3
    ...
    override fun parse(lines: List<String>): ParseResult {
        ...
        val nameSection = extractOrError(line1, 5..43, "name", errors)
        ...
        val personalNumber = extractOrError(line2, 28..41, "personalNumber", errors)?.replace("<", "")
        val personalChecksum = FieldExtractor.extractChecksum(line2, 42, "personalNumber")
        val compositeChecksum = FieldExtractor.extractChecksum(line2, 43, "composite")
        ...
        return if (errors.isEmpty()) {
            ParseResult.Success(
                MRZData(
                    ...
                    personalNumber = personalNumber?.takeIf { it.isNotEmpty() },
