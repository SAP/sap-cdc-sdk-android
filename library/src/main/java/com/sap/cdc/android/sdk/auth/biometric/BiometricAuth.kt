...
class BiometricAuth(private val sessionService: SessionService) {
    ...
    private fun secure(cipher: Cipher) {
        ...
        val json = esp.getString(com.sap.cdc.android.sdk.auth.session.SessionSecure.CDC_SESSIONS, null)
        ...
        esp.edit().putString(com.sap.cdc.android.sdk.auth.session.SessionSecure.CDC_SESSIONS, Json.encodeToString(sessionMap)).apply()
    }
