...
import com.sap.cdc.android.sdk.example.ui.viewmodel.AuthenticationViewModelPreviewMock
import com.sap.cdc.android.sdk.example.ui.viewmodel.IAuthenticationViewModel
...
@Composable
fun MyProfileView(viewModel: IAuthenticationViewModel) {
...
fun MyProfileViewPreview() {
    MyProfileView(AuthenticationViewModelPreviewMock())
